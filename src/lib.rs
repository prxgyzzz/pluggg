...
impl Plugin for MyPlugin {
    ...
    const VENDOR: &'static str = "Prxgyz";
    const URL: &'static str = "https://pudim.com.br";
    const EMAIL: &'static str = "@prxgyzzz";
...
impl ClapPlugin for MyPlugin {
    const CLAP_ID: &'static str = "com.Prxgyz.myplug";
...
impl Vst3Plugin for MyPlugin {
    const VST3_CLASS_ID: [u8; 16] = *b"MPrxgyzzzzPlugin";
